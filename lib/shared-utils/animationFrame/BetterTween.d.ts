 ...
 * ```
 */
export declare class BetterTween<G extends Record<string, any>> extends TWEEN.Tween<G> {
    /**
     * 销毁时需要执行的回调函数列表
     * @private
     */
     ...
     * ```
     */
    onDispose: (callback: DisposeCallback) => this;
    /**
     * 开始播放动画
     *
 ...
 * ```
 */
export declare function tweenProgress(duration?: number, easing?: typeof TWEEN.Easing.Linear.None): BetterTween<{
    progress: number;
}>;
export {};
