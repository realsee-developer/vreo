 ...
 * ```
 */
export function getMediaTypeByExpandedName(fileExpandedName?: string | null): MediaType {
 ...
 */
export function getMediaTypeByUrl(fileUrl?: string | null): MediaType | undefined {
